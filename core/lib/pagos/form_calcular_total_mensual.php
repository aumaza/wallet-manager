...
<html lang="es">
<head>
  <title>Wallet Manager - Calculo Total Mensual</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <?php skeleton(); ?>
</head>
...
<div class="container"><br>
  ...
  <?php
    ...
    if($conn){
        ...
        $nPago = new Pagos();
        $nPago->formCalcularTotalMensual($nServicio,$fecha_desde,$fecha_hasta,$conn,$dbname);
...
<script type="text/javascript" src="lib_pagos.js"></script>
</body>
</html>
